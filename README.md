...
![weahter](https://github.com/kProtect/Weather-Dashboard-v1.0/blob/main/forcasst.PNG?raw=true)

* Users search history will store on the broswer

![history](https://github.com/kProtect/Weather-Dashboard-v1.0/blob/main/history.PNG?raw=true)
